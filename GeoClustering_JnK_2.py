...
if(os.path.exists(path+"Analysis/JnK_TwitterUsersIDs.txt")):
	...
	f.close()
if(os.path.exists(path+"Analysis/JnK_TwitterUsersIDs_2.txt")):
	f=open(path+"Analysis/JnK_TwitterUsersIDs_2.txt", 'r')
	lines = f.readlines()
	for e in lines:	
		userid[int(e.strip())]=0
	f.close()
...
fha1=open(path+"Analysis/JnK_TwitterUsersIDs_2.txt",'a')


file_path_arff=path+"Analysis/JnK_TwitterUsersData_2.txt"
