...
api = tweepy.API(auth)
all_tweets=[]
BasePath="/home/pawan/MTech2.2/MTP/MTPCodeData/"

#thfd=open('/home/pawan/MTech2.1/MTP/MTPCode/tweet_AP_handle','r')
thfd=open(BasePath+'allhandles','r')
flag=0
...
for handle in thfd:
	...
	all_tweets=[]
	handle=handle.strip()
	file_path=BasePath+'tweetcorpus_ARFF/'+str(handle)+'_since_id'
	...
	if(flag==1):
		...
		try:
			...
			print "proble2"
	tf = open(BasePath+'tweetcorpus_ARFF/'+handle, 'a')
	file_path_arff=BasePath+'tweetcorpus_ARFF/'+handle+'_arff.arff'
